...
class SmoothieHandler(PrinterEventHandler):
    ...
    def on_recv(self, line):
        ...
        elif self.is_grid_saved(line.strip()):
            self.create_connection_and_send("ws://127.0.0.1:8888/grid-saved", line.strip())
    ...
    def is_grid_saved(self, data):
        return "grid saved" in data
