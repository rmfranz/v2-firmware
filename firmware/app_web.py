...
class Application(tornado.web.Application):
    ...
    def __init__(self):
        handlers = [
            ...
            (r"/ext_1/load", LoadUnloadFilamentsHandler),
            (r"/ext_1/unload", LoadUnloadFilamentsHandler),
            (r"/ext_2/load", LoadUnloadFilamentsHandler),
            (r"/ext_2/unload", LoadUnloadFilamentsHandler),
